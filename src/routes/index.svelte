...
<div class="home">
	{#each videos as video}
		<a rel="external" target="_blank" href={`https://www.youtube.com/watch?v=${video.snippet.resourceId.videoId}`} class="video" style={`background-image: url(${getThumbnailUrl(video.snippet.thumbnails)})`}>
